...
package meteordevelopment.meteorclient.rejects.utils;
...
public class RejectsUtils {
    ...
    public static void init() {
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            ...
            RejectsConfig.get().save(NerdHack.FOLDER);
        }));
    }
    ...
    public static String getModuleName(String name) {
        ...
        if (modules == null) {
            NerdHack.LOG.warn("Module instantiation before Modules initialized.");
            return name;
        }
