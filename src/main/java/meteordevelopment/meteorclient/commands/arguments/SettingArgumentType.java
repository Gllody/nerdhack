...
public class SettingArgumentType implements ArgumentType<String> {
    ...
    private static final DynamicCommandExceptionType NO_SUCH_SETTING = new DynamicCommandExceptionType(name -> Text.literal("No such setting1 '" + name + "'."));
    ...
    public static Setting<?> get(CommandContext<?> context) throws CommandSyntaxException {
        ...
        String settingName = context.getArgument("setting1", String.class);
