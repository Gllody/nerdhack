...
public class BaritoneSettings implements IPathManager.ISettings {
    ...
    private static void loadDescriptions() {
        ...
        addDescription("avoidUpdatingFallingBlocks", "If this setting1 is true, Baritone will never break a block that is adjacent to an unsupported falling block.");
        ...
        addDescription("cachedChunksOpacity", "0.0f = not visible, fully transparent (instead of setting1 this to 0, turn off renderCachedChunks) 1.0f = fully opaque");
        ...
        addDescription("chatControlAnyway", "Some clients like Impact try to force chatControl to off, so here's a second setting1 to do it anyway");
        ...
        addDescription("costHeuristic", "This is the big A* setting1.");
        ...
        addDescription("internalMiningAirException", "Modification to the previous setting1, only has effect if forceInternalMining is true If true, only apply the previous setting1 if the block adjacent to the goal isn't air.");
        ...
        addDescription("schematicOrientationX", "When this setting1 is true, build a schematic with the highest X coordinate being the origin, instead of the lowest");
        addDescription("schematicOrientationY", "When this setting1 is true, build a schematic with the highest Y coordinate being the origin, instead of the lowest");
        addDescription("schematicOrientationZ", "When this setting1 is true, build a schematic with the highest Z coordinate being the origin, instead of the lowest");
