...
public class KeyBinds {
    private static final String CATEGORY = "Nerd Hack";

    public static KeyBinding OPEN_GUI = new KeyBinding("key.nerd-client.open-gui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, CATEGORY);
    public static KeyBinding OPEN_COMMANDS = new KeyBinding("key.nerd-client.open-commands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_PERIOD, CATEGORY);
