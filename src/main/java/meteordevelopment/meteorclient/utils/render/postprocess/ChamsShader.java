...
public class ChamsShader extends EntityShader {
    ...
    public ChamsShader() {
        NerdHack.EVENT_BUS.subscribe(ChamsShader.class);
    }
    ...
    public static void load() {
        try {
            ...
            for (String fileFormat : FILE_FORMATS) {
                Optional<Resource> optional = mc.getResourceManager().getResource(NerdHack.identifier("textures/chams." + fileFormat));
