...
public class Fonts {
    public static final String[] BUILTIN_FONTS = { "JetBrains Mono", "BlackLives-MVWGx", "ComicSansMS400", "Comfortaa", "Tw Cen MT", "Pixelation" };
    ...
    public static void refresh() {
        ...
        NerdHack.LOG.info("Found {} font families.", FONT_FAMILIES.size());
    ...
    public static void load(FontFace fontFace) {
        ...
        try {
            ...
            NerdHack.EVENT_BUS.post(CustomFontChangedEvent.get());
        }
        catch (Exception e) {
            ...
            NerdHack.LOG.error("Failed to load font: " + fontFace, e);
