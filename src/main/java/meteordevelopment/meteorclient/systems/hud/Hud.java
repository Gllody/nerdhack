...
public class Hud extends System<Hud> implements Iterable<HudElement> {
    public static final HudGroup GROUP = new HudGroup("NerdHack");
    ...
    public void init() {
        ...
        register(Keys.INFO);
        register(BlackoutArray.INFO);
        register(AnimeGirl.INFO);
        register(CatGirl.INFO);
    ...
    private void resetToDefaultElementsImpl() {
        ...
        add(BlackoutArray.INFO, 4, 4 + h, XAnchor.Left, YAnchor.Top);



        // Top Right
        add(MeteorTextHud.FPS, -4, 4 + h, XAnchor.Right, YAnchor.Top);
        add(MeteorTextHud.TPS, -4, 4 + h * 2, XAnchor.Right, YAnchor.Top);
        add(MeteorTextHud.PING, -4, 4 + h * 3, XAnchor.Right, YAnchor.Top);
        add(MeteorTextHud.SPEED, -4, 4 + h * 4, XAnchor.Right, YAnchor.Top);
        add(Keys.INFO, -4, 4 + h * 6, XAnchor.Right, YAnchor.Top);
        ...
        add(TargetHud.INFO, 3, -4 - h * 4, XAnchor.Right, YAnchor.Bottom);
    }
