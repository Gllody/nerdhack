...
public class MeteorTextHud {
    ...
    static {
        ...
        POSITION = addPreset("Position", "XYZ: #1{floor(camera.pos.x)}, {floor(camera.pos.y)}, {floor(camera.pos.z)}", 0);
        ...
        WATERMARK = addPreset("Watermark", "#0Nerd#2Hack#1@#0{meteor.version} #2$ #0{server}");
