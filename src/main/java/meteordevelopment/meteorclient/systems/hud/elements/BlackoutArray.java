...
public class BlackoutArray extends HudElement {
    ...
    private final Setting<SettingColor> color = sgGeneral.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(0, 255, 76, 255))
        .build()
    );
    ...
    private final Setting<Boolean> onlyExploits = sgGeneral.add(new BoolSetting.Builder()
        .name("Only Exploits")
        .description("Only shows Exploit modules in the hud.")
        .defaultValue(false)
        .build()
    );
    ...
    private final Setting<SettingColor> waveColor = sgWave.add(new ColorSetting.Builder()
        ...
        .description("The color the ArrayList will use for module names.")
        .defaultValue(new SettingColor(196, 255, 196, 255))
        .build()
    );
    ...
    public static final HudElementInfo<BlackoutArray> INFO = new HudElementInfo<>(Hud.GROUP, "NiceArray", "An ArrayList for cool people.", BlackoutArray::new);
    ...
    private List<Module> getModules() {
        return Modules.get().getActive()
            .stream()
            .filter(module -> !onlyExploits.get() || module.category.equals(Categories.Exploits))
            .collect(Collectors.toList());
    }
