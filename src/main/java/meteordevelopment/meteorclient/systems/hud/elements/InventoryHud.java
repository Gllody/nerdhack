...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = NerdHack.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = NerdHack.identifier("textures/container-transparent.png");
