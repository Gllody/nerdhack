...
public class Scaffold extends Module {
    ...
    private final Setting<List<Block>> blocks = sgGeneral.add(new BlockListSetting.Builder()
        ...
        .defaultValue(Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX)
        .build()
    );
    ...
    public Scaffold() {
        super(Categories.Movement, "Scaffold", "Automatically places blocks under you. Credits to MeteorTweaks.");
    }
