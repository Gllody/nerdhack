...
import meteordevelopment.meteorclient.systems.modules.exploits.FlightAntikick;
...
public class AutoLavaCaster extends Module {
    ...
    public AutoLavaCaster() {
        super(Categories.Movement, "AutoLavaCaster", "Make Layers of Cobble on your Stairs! Aim at the top of the block you want to lava on.");
    }
