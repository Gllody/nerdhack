...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        NerdHack.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        NerdHack.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        NerdHack.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        NerdHack.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
