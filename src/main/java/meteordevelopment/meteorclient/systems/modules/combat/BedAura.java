...
import meteordevelopment.meteorclient.utils.orion.Wrapper;
import meteordevelopment.meteorclient.utils.orion.AutomationUtils;
import meteordevelopment.meteorclient.utils.orion.BedUtils;
import meteordevelopment.meteorclient.utils.orion.ItemHelper;
import meteordevelopment.meteorclient.utils.orion.BlockHelper;
...
public class BedAura extends Module {
    ...
    public BedAura() {
        super(Categories.Combat, "bed-aura", "The famous troll module.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (placePos == null && AutomationUtils.isWebbed(target) && breakWeb.get()) {
            ...
            if (sword.found()) {
                ...
                if (webTimer <= 0) {
                    info("Breaking " + target.getName() + "'s web.");
                    webTimer = 100;
                } else {
                    webTimer--;
                }
