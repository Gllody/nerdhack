...
import meteordevelopment.meteorclient.systems.enums.RotationType;
import meteordevelopment.meteorclient.systems.enums.SwingHand;
import meteordevelopment.meteorclient.systems.enums.SwingState;
import meteordevelopment.meteorclient.systems.enums.SwingType;
import meteordevelopment.meteorclient.managersb.Managers;
import meteordevelopment.meteorclient.systems.blackoutfiles.TimerList;
import meteordevelopment.meteorclient.systems.blackoutfiles.BOInvUtils;
import meteordevelopment.meteorclient.systems.blackoutfiles.OLEPOSSUtils;
import meteordevelopment.meteorclient.systems.blackoutfiles.PlaceData;
import meteordevelopment.meteorclient.systems.blackoutfiles.SettingUtils;
...
public class SurroundPlus extends Module {
    ...
    private void place(BlockPos pos) {
        ...
        if (SettingUtils.shouldRotate(RotationType.BlockPlace) && !Managers.ROTATION.start(data.pos(), EventPriority.HIGHEST, RotationType.BlockPlace, Objects.hash(name + "placing"))) {return;}
