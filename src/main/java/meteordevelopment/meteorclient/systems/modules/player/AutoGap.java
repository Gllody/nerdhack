...
import meteordevelopment.meteorclient.systems.modules.combat.OldBedAura;
...
public class AutoGap extends Module {
    private static final Class<? extends Module>[] AURAS = new Class[] { KillAura.class, CrystalAura.class, AnchorAura.class, OldBedAura.class };
