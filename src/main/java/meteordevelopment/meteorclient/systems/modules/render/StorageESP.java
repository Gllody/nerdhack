...
public class StorageESP extends Module {
    ...
    private final Setting<SettingColor> openedColor = sgOpened.add(new ColorSetting.Builder()
        .name("opened-color")
        .description("Optional setting1 to change colors of opened chests, as opposed to not rendering. Disabled at zero opacity.")
    ...
    private void onRender(Render3DEvent event) {
        ...
        for (BlockEntity blockEntity : Utils.blockEntities()) {
            ...
            if (interacted && openedColor.get().a > 0) {
                ...
                sideColor.a = fillOpacity.get(); // Maintain fill opacity setting1 for consistency
            }
