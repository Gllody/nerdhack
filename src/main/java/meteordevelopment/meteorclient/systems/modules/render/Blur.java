...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        NerdHack.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            // Resize all fbos
        ...
        NerdHack.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
