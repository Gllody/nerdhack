...
public class HighwayBuilder extends Module {
    ...
    public void onActivate() {
        ...
        if (Modules.get().get(InstantRebreak.class).isActive()) warning("It's recommended to disable the Instant Rebreak module and instead use the 'instantly-rebreak-echests' setting1 to avoid errors.");
    }
